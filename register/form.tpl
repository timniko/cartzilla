{block name='register-form'}
    {form action="{get_static_route id='registrieren.php'}" class="needs-validation register-form clearfix" slide=true novalidate=true}
        {block name='register-form-content'}
            ...
            {/block}
            {block name='register-form-hr'}{/block}
