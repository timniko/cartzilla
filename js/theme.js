...
(function () {
  ...
  */
  ...
  var imageZoom = function () {
    ...
    for (var i = 0; i < images.length; i++) {
			new Drift(images[i], {
        paneContainer: images[i].parentElement.parentElement.querySelector('.image-zoom-pane')
      });
    }
  }();
  /**
  ...
  */
	...
	const sliderUpdate = new Event("sliderUpdate");
        ...
        if (handle) {
          ...
          valueMinInput.value = Math.round(value);
			...
			rangeSlider.noUiSlider.on('end', function() {
				document.dispatchEvent(sliderUpdate);
      });
